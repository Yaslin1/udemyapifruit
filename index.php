...
<body>
    ...
    if ($fruitInfo != "") {
        ...
        echo $spaces . "Carbs: " . $fruitsInfo['nutritions']['carbohydrates'] . "<br>";
        echo $spaces . "Protein: " . $fruitsInfo['nutritions']['protein'] . "<br>";
        echo $spaces . "Fat: " . $fruitsInfo['nutritions']['fat'] . "<br>";
        echo $spaces . "Calories: " . $fruitsInfo['nutritions']['sugar'] . "<br>";
    }
